        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview active">
            ...
            <ul class="treeview-menu">
              ...
              <li class="active"><a href="<?= base_url('admin/form_mp') ?>"><i class="fa fa-circle"></i> Ruang Multimedia Purpose</a></li>
          ...
          <div class="col-md-12">
            <div class="container">
              ...
              <div class="box box-primary" style="width:94%;">
                ...
                <!-- form start -->
                <div class="container">
                  <form action="<?= base_url('admin/proses_data_mp') ?>" role="form" method="post">
