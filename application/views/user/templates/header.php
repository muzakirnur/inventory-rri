          ...
          <ul class="nav navbar-nav mr-auto">
            ...
            <li class="dropdown"><a class="bg-dark dropdown-toggle" data-toggle="dropdown" href="#"><i class="fa fa-database" aria-hidden="true"></i> Tabel <span class="caret"></span></a>
              <ul class="dropdown-menu">
                <li><a href="<?=base_url('user/tabel_rekaman');?>">Tabel Rekaman</a></li>
                <li><a href="<?=base_url('user/tabel_mp');?>">Tabel Multimedia Purpose</a></li>
                <li><a href="<?=base_url('user/tabel_pro1');?>">Tabel Pro 1</a></li>
                <li><a href="<?=base_url('user/tabel_pro2');?>">Tabel Pro 2</a></li>
